...
class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    func applicationDidFinishLaunching(_ notification: Notification) {
        ...
        // Restore custom app icon if one was set by the user
        if let iconData = Defaults[.customAppIconData],
        ...
        // Start AI agent socket server and install Claude Code hooks
        AIAgentManager.shared.start()
